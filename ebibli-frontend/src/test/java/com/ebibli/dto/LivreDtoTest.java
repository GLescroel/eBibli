...
public class LivreDtoTest {
    ...
    public void testGettersAndSetters() {
        ...
        livre.setEmpruntEnCours(new EmpruntDto().builder().id(1).build());
        ...
        Assert.assertEquals(java.util.Optional.of(1).get(), livre.getEmpruntEnCours().getId());
    }
    ...
    public void testBuilder() {
        LivreDto livre = new LivreDto().builder()
                ...
                .empruntEnCours(new EmpruntDto().builder().id(1).build())
                .build();
